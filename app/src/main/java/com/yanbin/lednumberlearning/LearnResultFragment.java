 ...
 */
public class LearnResultFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        rec_number.setLayoutManager(new LinearLayoutManager(context));
        rec_number.setAdapter(new ResultAdapter(context));
